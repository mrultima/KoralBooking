...
export class BlobStorageService {
  ...
  uploadToBlobStorage(sasToken: ISasToken, file: File, blockSize?: number): Observable<number> {
    const customBlockSize = blockSize || this.getBlockSize(file);
